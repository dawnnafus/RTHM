...
ces_df <- merge(new_data, ces_lat_cc@data, by = "id")
```
...
## Dashboard
```{r shiny, echo=F, message=F, warning=F}
library(rsconnect)
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      sliderInput(inputId = "age_range",
              ...
              value = c(20,80),
              step = 5),
      sliderInput(inputId = "time_in_area",
              label = "Time in Area", min= 0 , max = 100,
              value = c(20,50),
              step = 5),
      checkboxGroupInput(
  ...
  output$plotLeaf <- renderLeaflet({
    ...
    leaflet(some_data) %>% 
      ...
      addCircleMarkers(
        ...
        stroke = FALSE,
        fillOpacity = 1,
        popup = paste0("<b>ID: </b>", "<b>",id,"</b>", "<br>",
                       "Age: ", age, "<br>",
                       "Sex: ", sex, "<br>",
                       "Time in area: ", time_in_area, " years"))
  })
