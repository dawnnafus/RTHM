...
# List of R packages
required_pkg <- c("tidyverse","maptools", "rgdal", "spatstat")
...
library(ggmap)
# Collect addresses
m3_locale = as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
m5_locale = as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
m7_locale = as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
m9_locale = as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
m10_locale =as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
m11_locale =as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
m16_locale =as.numeric(geocode("2315 Durant Ave, Berkeley, CA 94704", source="google"))
...
fb_intraday <- full_join(fb_intraday, demographics, by = "id")
paco_hourly <- full_join(paco_hourly, demographics, by = "id")
```
...
df <- full_join(full_time, air_qual_4901, by = "day") %>%
  ...
  bind_rows(fb_test, .id = NULL) %>%
  bind_rows(paco_test, .id = NULL) %>%
