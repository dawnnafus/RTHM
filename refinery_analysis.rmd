...
library(ggmap)
# Collect addresses
m3_locale = as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
m5_locale = as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
m7_locale = as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
m9_locale = as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
m10_locale =as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
m11_locale =as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
m16_locale =as.numeric(geocode("460 3rd St, Richmond, CA 94801", source="google"))
