...
correlation_fun <- function(ind_data = individual_data, air_data = air_quality, 
...
# Downside is it will be more interaction with actual code. Upside is it can be done. 
