...
# No filter function
correlation <- function(ind_data = ind_data_filtered, air_data = air_quality, 
...
# Will need to apply filters here as well
...
mean_bo<- mean(individual_data$blood_oxygen, na.rm=T)
cat("Blood Oxygen and Sulfur Dioxide")
t.test(x = temp_bosd$mean_bo, y = individual_data$blood_oxygen)
