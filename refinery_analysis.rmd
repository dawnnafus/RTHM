...
cc_wgs84 <- spTransform(cc, CRS("+proj=longlat +datum=WGS84 +no_defs"))
# summary(cc_wgs84)
...
ggplot(cc_wgs84, aes(x=long, y=lat)) +   
...
# Saves plot of contra costa county
cc_map <- 
...
center = apply(coordinates(cc_wgs84), 2, mean)[2:1]
